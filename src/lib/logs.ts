...
export const LOGGER_CATEGORY_ENDPOINT = 'ENDPOINT';
export const LOGGER_CATEGORY_FEDERATOR = 'FEDERATORS';
export const LOGGER_CATEGORY_FEDERATOR_FUND = 'FUND_FEDERATORS';
export const LOGGER_CATEGORY_FEDERATOR_MAIN = 'MAIN_FEDERATOR';
export const LOGGER_CATEGORY_FEDERATOR_DATABASE = 'FEDERATOR_DATABASE';
export const LOGGER_CATEGORY_FEDERATOR_SIDE = 'SIDE_FEDERATOR';
